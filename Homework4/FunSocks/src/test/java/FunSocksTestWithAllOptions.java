...
public class FunSocksTestWithAllOptions {
    WebDriver driver;
    String url = "https://qajava.skillbox.ru/module04/homework/auth/changed.html";

    private By emailLocator = By.cssSelector("input#email.form-input.input-data");
    private By passwordLocator = By.cssSelector("input#password.form-input.password");
    private By sendBtnLocator = By.cssSelector("button#submit.form-submit");
    private By errorLocator = By.cssSelector("pre#error.form-error-password-email");
