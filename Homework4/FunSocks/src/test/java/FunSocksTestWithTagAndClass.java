...
public class FunSocksTestWithTagAndClass {
    WebDriver driver;
    ...
    private By sendBtnLocator = By.cssSelector("button.form-submit");
    private By errorLocator = By.cssSelector("pre.form-error-password-email");
